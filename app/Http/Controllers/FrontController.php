...
class FrontController extends Controller
{
    ...
    public function comment_post(Request $request)
    {
        ...
        toastr()->success("نظر شما با موفقیت اضافه شد و پس از بررسی برای عموم نمایش داده خواهد شد");
    ...
    public function contact_post(Request $request)
    {
        ...
        toastr()->success('پیام شما با موفقیت دریافت شد و در اسرع وقت با شما تماس خواهیم گرفت');
