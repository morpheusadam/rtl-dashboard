                    ...
                    <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <select class="form-control select2-select" name="type" id="type">
                                <option value="CUSTOM_LINK" @if(old('type')=="CUSTOM_LINK") selected @endif>لینک سفارشی</option>
                                <option value="PAGE" @if(old('type')=="PAGE") selected @endif>صفحه</option>
                                <option value="CATEGORY" @if(old('type')=="CATEGORY") selected @endif>دسته‌بندی</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 p-2">
