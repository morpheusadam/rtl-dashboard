...
<div class="col-12 py-0 px-3 row">
    <div class="col-12  pt-2" style="min-height: 80vh">
        ...
        <div class="col-12 col-lg-9 px-3 py-5 د-flex mx-auto justify-content-center align-items-center">
                ...
                <div class="col-12 row p-0">
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                        <a href="{{route('admin.articles.index',['user_id'=>$user->id])}}" style="color:inherit;">
                            <div class="col-12 px-0 py-2 د-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                <div style="width: 80px;" class="p-2">
                                    <div class="col-12 px-0 text-center د-flex align-items-center justify-content-center" style="background-image: linear-gradient(rgba(0,0,0,.04),rgba(0,0,0,.04))!important;height: 64px;border-radius: 50%;">
                                        <span class="fal fa-book font-5"></span>
                                    </div>
                                </div>
                                <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                    <h6 class="font-1">مقالات</h6>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                        <a href="{{route('admin.traffics.error-reports',['user_id'=>$user->id])}}" style="color:inherit;">
                            <div class="col-12 px-0 py-2 د-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                ...
                                <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                    <h6 class="font-1">گزارش خطاها</h6>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                        <a href="{{route('admin.contacts.index',['user_id'=>$user->id])}}" style="color:inherit;">
                            <div class="col-12 px-0 py-2 د-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                ...
                                <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                    <h6 class="font-1">درخواست‌های تماس</h6>
