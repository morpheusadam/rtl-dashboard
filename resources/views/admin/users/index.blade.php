...
<div class="col-12 p-3">
	...
	<x-bread-crumb :breads="[
			...
			['url' => route('admin.users.index') , 'title' => 'کاربران' , 'isactive' => true],
		]">
		</x-bread-crumb>
	<!-- /breadcrumb -->
		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-users"></span>	کاربران
				</div>
				...
				<div class="col-12 col-lg-4 p-2 text-lg-end">
					...
					<span class="btn btn-primary"><span class="fas fa-plus"></span> افزودن جدید</span>
					</a>
					@endcan
				</div>
			</div>
					...
					<tr>
						...
						<td>
							...
							<span class="btn  btn-outline-primary btn-sm font-small mx-1">
								<span class="fas fa-search "></span> مشاهده
							</span>
							</a>
							@endcan
							...
							<span class="btn  btn-outline-primary btn-sm font-small mx-1">
								<span class="far fa-bells"></span> اطلاعیه‌ها
							</span>
							</a>
...
<span class="btn btn-outline-primary btn-sm font-small mx-1">
    <span class="fal fa-key "></span> نقش‌ها
</span>
</a>
@endcan
...
<span class="btn  btn-outline-success btn-sm font-small mx-1">
    <span class="fas fa-wrench "></span> ویرایش
</span>
</a>
@endcan
...
<form method="POST" action="{{route('admin.users.destroy',$user)}}" class="d-inline-block">@csrf @method("DELETE")
    <button class="btn  btn-outline-danger btn-sm font-small mx-1" onclick="var result = confirm('آیا از حذف این کاربر مطمئن هستید؟');if(result){}else{event.preventDefault()}">
...
<div class="dropdown d-inline-block">
    ...
    @can('users-update')
    <li><a class="dropdown-item font-1" href="{{route('admin.users.access',$user)}}"><span class="fal fa-eye"></span> ورود</a></li>
    @endcan

    @can('users-update')
    <li><a class="dropdown-item font-1" href="{{route('admin.traffics.logs',['user_id'=>$user->id])}}"><span class="fal fa-boxes"></span> نظارت بر فعالیت <span class="badge bg-danger">{{$user->logs_count}}</span></a></li>
    @endcan
    </ul>
</div>
</td>
