		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-articles"></span> مقالات
				</div>
						...
						<td style="width: 360px;">
							...
							<a href="{{route('article.show',['article'=>$article])}}">
								<span class="btn  btn-outline-primary btn-sm font-1 mx-1">
									<span class="fas fa-search "></span> نمایش
								</span>
							</a>
							@endcan
							...
							<a href="{{route('admin.article-comments.index',['article_id'=>$article->id])}}">
								<span class="btn  btn-outline-primary btn-sm font-1 mx-1">
									<span class="fas fa-comments "></span> نظرات
								</span>
							</a>
							@endcan
							...
							<form method="POST" action="{{route('admin.articles.destroy',$article)}}" class="d-inline-block">@csrf @method("DELETE")
								<button class="btn  btn-outline-danger btn-sm font-1 mx-1" onclick="var result = confirm('آیا از حذف این مورد مطمئن هستید؟');if(result){}else{event.preventDefault()}">
