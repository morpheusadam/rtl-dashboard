		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row ">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-contacts"></span> اعلان‌ها
				</div>
				...
				<div class="col-12 col-lg-4 p-2 text-lg-end">
					@can('announcements-create')
		 			<a href="{{route('admin.announcements.create')}}">
		 				<button class="btn btn-primary pb-2"><span class="fas fa-plus"></span> افزودن اعلان</button>
		 			</a>
		 			@endcan
				</div>
			</div>
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td class=" row d-flex">
		      	...
		      	<a href="#" style="width: 30px;height: 30px;color: #fff;background: #c00;border-radius: 2px" class="d-flex align-items-center justify-content-center mx-1" onclick='var result = confirm("آیا از حذف این مورد مطمئن هستید؟");if (result) {$("#announcement_delete_{{$announcement->id}}").submit();}'>
