			...
			<div class="row col-12 align-items-center" style="min-height: 80vh;margin: 0% 0px;">
				<div class="row align-items-center py-5 main-nafez-box-styles" style=";border-radius: 12px">
					<div class="col text-center py-5">
						...
						<h4 class="text-center">404 | صفحه مورد نظر یافت نشد</h4>
						<br>
						<div class="col-12 text-center px-2" dir="ltr" style="padding-top: 8px;">
						<a href="/" class="d-inline-block ">
						<span class="btn btn-primary cairo px-5" style=" padding: 5px 10px 9px;cursor: pointer;border:none;border-radius: 90px;"> <span class="fal fa-home font-1 " style="color: #fff"></span> صفحه اصلی </span>
						</a>
						</div>
					</div>
				</div>
