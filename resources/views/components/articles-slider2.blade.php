  ...
  <div class="container py-14 py-md-16">
    <div class="row">
      <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto">
        ...
        <h3 class="display-4 mb-6 text-center">ما آخرین اخبار خود را با شما به اشتراک می‌گذاریم.</h3>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
                ...
                <article>
                  <div class="card">
                    <figure class="card-img-top overlay overlay-1 hover-scale"><a href="#"> <img src="/assets/img/photos/7.jpg" alt="" /></a>
                      <figcaption>
                        <h5 class="from-top mb-0 text-center">مشاهده بیشتر</h5>
                      </figcaption>
                    </figure>
                    <div class="card-body">
                      <div class="post-header">
                        <div class="post-category text-line">
                          <a href="#" class="hover" rel="category">کارآفرینی</a>
                        </div>
                        <!-- /.post-category -->
                        <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="#">این متن مثالی است برای متنی که می‌تواند در همان فضا جایگزین شود</a></h2>
                      </div>
                      <!-- /.post-header -->
                      <div class="post-content">
                        <p>این متن مثالی است برای متنی که می‌تواند در همان فضا جایگزین شود.</p>
                      </div>
                      <!-- /.post-content -->
                    </div>
                    <!--/.card-body -->
