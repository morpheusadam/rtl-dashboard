      ...
      <div class="col-xl-10 mx-auto">
        <div class="row mb-3 d-flex">
          ...
          <div class="col-md-3 mb-3">
            <div class="widget">
              <div class="widget-title display-6 mb-5" >لینک‌ها</div>
          ...
          <div class="col-md-3 mb-3">
            <div class="widget">
              <div class="widget-title display-6 mb-5" >ما را دنبال کنید</div>
