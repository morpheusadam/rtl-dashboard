<section class="wrapper bg-light">
  <div class="container py-14 py-md-16">
    <h2 class="display-4 mb-3 text-center">سوالات متداول</h2>
    <p class="lead text-center mb-10 px-md-16 px-lg-0">ما به سوالات شما به صورت پرسش و پاسخ پاسخ می‌دهیم.</p>
    <div class="row">
