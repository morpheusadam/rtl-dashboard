      ...
      <div class="container h-100 d-flex align-items-center justify-content-center">
        <div class="row">
          <div class="col-lg-12 mx-auto mt-n10 text-center">
              <h2 class="display-1 fs-60 text-white mb-5 animate__animated animate__zoomIn animate__delay-1s font-lg-10" >آلفا برای کنفرانس‌ها و نمایشگاه‌ها</h2>
              <h1 class="fs-19 text-uppercase ls-xl text-white mb-0 animate__animated animate__zoomIn animate__delay-2s ">یک شرکت ملی با ویژگی‌های جهانی، با هویت کوردی و روحیه‌ای پرشور و شگفت‌انگیز</h1>
          </div>
        </div>
      </div>
    </div>
