              ...
              <div class="p-10 p-md-11 p-lg-14">
                <div class="d-flex flex-row">
                  ...
                  <div class="align-self-start justify-content-start">
                    ...
                    <address> کردستان - بانه - خیابان بهارستان 13</address>
                  </div>
                </div>
                <!--/div -->
                <div class="d-flex flex-row">
                  ...
                  <div>
                    ...
                    <p>09981322051 <br class="d-none d-md-block" />09185312051</p>
                  </div>
                </div>
                <!--/div -->
                <div class="d-flex flex-row">
                  ...
                  <div>
                    ...
                    <p class="mb-0"><a href="mailto:sandbox@email.com" class="link-body">morpheusadam95@gmail.com</a></p>
                    <p class="mb-0"><a href="mailto:help@sandbox.com" class="link-body">support@morpheusadam.com</a></p>
                  </div>
                </div>
                <!--/div -->
              </div>
