  ...
  <div class="container py-14 py-md-16 text-center">
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
        <h2 class="fs-15 text-uppercase text-muted mb-3 text-center">چه خدماتی ارائه می‌دهیم؟</h2>
        <h3 class="display-4 mb-10 px-xl-10 text-center">لیست خدماتی که به شما ارائه می‌دهیم.</h3>
      </div>
      <!-- /column -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body text-center">
              ...
              <h4 class="text-center">برگزاری رویدادها</h4>
              <p class="mb-2">این متن نمونه‌ای از متنی است که می‌تواند در همان فضا جایگزین شود. این متن توسط مولد متون در ابزارهای پلتفرم نفذلی تولید شده است، جایی که می‌توانید مشابه آن را تولید کنید.</p>
            </div>
