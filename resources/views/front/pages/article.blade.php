                ...
                <div class="col-12 p-2 p-lg-3 rounded-2" style="background: var(--bg-main);">
                    ...
                    <div class="col-12 p-4 card-body">
                        ...
                        <ul class="post-meta mb-5">
                            ...
                            <li class="post-comments"><a href="#comments"><i class="fal fa-comment"></i> {{$article->comments_count}}<span> نظرات</span></a></li>
                            @endif
                            @if($article->views!=0)
                            <li class="post-comments"><a href="#comments"><i class="fas fa-fa-thin fa-eyes"></i> {{$article->views}}<span> بازدید</span></a></li>
                            @endif
                        </ul>
                        ...
                        {{-- <div class="author-info d-md-flex align-items-center mb-3 text-center col-12">
                            <div class="d-flex align-items-center row mx-auto">
                                <div class="col-12 text-center د-flex align-items-center justify-content-center ">
                        ...
                        <div class="col-12 p-0">
                            ...
                            <hr />
                            <div id="comments">
                                <h3 class="mb-6">{{$article->comments_count}} نظرات</h3>
                            ...
                            @endif
                            <hr />
                            <h3 class="mb-3">نظر خود را با ما به اشتراک بگذارید</h3>
                            <p class="mb-7">ایمیل شما منتشر نخواهد شد.</p>
                            <form class="comment-form" method="POST" action="{{route('comment-post')}}">
                                @csrf
                                <input type="hidden" name="article_id" value="{{$article->id}}">
                                @guest
                                <div class="form-floating mb-4">
                                    <input type="text" class="form-control" placeholder="نام*" id="c-name" name="adder_name">
                                    <label for="c-name">نام *</label>
                                </div>
                                <div class="form-floating mb-4">
                                    <input type="email" class="form-control" placeholder="ایمیل*" id="c-email" name="adder_email">
                                    <label for="c-email">ایمیل*</label>
                                </div>
                                @endguest
                                <div class="form-floating mb-4">
                                    <textarea name="content" class="form-control" placeholder="نظر شما" style="height: 150px"></textarea>
                                    <label>نظر شما *</label>
                                </div>
                                <button type="submit" class="btn btn-primary rounded-pill mb-0">افزودن نظر</button>
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12 p-0 d-flex row">
                                ...
                                <div class="px-2" style="width:calc(100% - 75px)">
                                    <div style="font-size:13px;font-weight: bold;" class="col-12">
                                        <a href="{{route('article.show',$single_article)}}" class="px-0 د-flex" style="color:var(--font-color);">
