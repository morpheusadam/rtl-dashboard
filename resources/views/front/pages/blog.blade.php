@extends('layouts.app',['page_title'=>"وبلاگ"])
@section('content')
	        ...
	        <div class="container py-12 py-md-10 text-center">
	          <div class="row">
	            <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
	              <h1 class="display-1 mb-3 text-center">وبلاگ</h1>
	              <p class="lead px-lg-5 px-xxl-8 mb-1 text-center">اینجا آخرین مقالات ما را مشاهده کنید.</p>
	            </div>
	            <!-- /column -->
	          </div>
	          <!-- /.row -->
