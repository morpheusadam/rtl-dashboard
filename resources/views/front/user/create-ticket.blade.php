                        ...
                        <div class="hero">
                            <form action="{{route('user.store-ticket')}}" class="row justify-content-center" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-11 col-12 mb-3">
                                    ...
                                    <textarea class="form-control" style="min-height: 200px" placeholder="محتوای پیام" name="message"></textarea>
                                </div>
                                <div class="col-lg-11 col-12 mb-3">
                                ...
                                <div class="col-lg-11 col-12 mb-3 ">
                                    <button type="submit" class="btn btn-outline-warning">باز کردن تیکت</button>
                                </div>
