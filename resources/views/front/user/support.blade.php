...
<div class="col-12 p-4 mb-3 d-flex align-items-center justify-content-center" style="background: #fff;border-radius: 8px;min-height: 40vh;">
    <div class="col-12 text-center">
        ...
        <div class="col-12 text-center py-3">
            هر زمان که نیاز به کمک داشتید با ما تماس بگیرید
        </div>
        <div class="col-12 p-2 text-center">
            <a href="{{route('user.create-ticket')}}" class="btn btn-outline-warning rounded-pill font-2 px-8"><span class="fal fa-comments-alt mx-2"></span> تیکت جدید</a>
        </div>
    </div>
