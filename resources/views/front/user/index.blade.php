...
<div class="col-12 p-4 mb-3 d-flex align-items-center justify-content-center" style="background: #fff;border-radius: 8px;min-height: 40vh;">
	<div class="col-12 text-center">
		...
		<div class="col-12 text-center py-3">
			هیچ اطلاعاتی در حساب شما وجود ندارد
		</div>
		<div class="col-12 p-2 text-center">
			<a href="/" class="btn btn-outline-warning rounded-pill font-2 px-8"><span class="fal fa-home "></span> <span class="mx-2">نمایش صفحه اصلی</span> </a>
		</div>
	</div>
