...
<div class="blog-style">
	<div class="col-12 p-0 " style="height:400px;position: relative;">
		...
		<div class="col-12 p-2 position-relative-inner d-flex align-items-center justify-content-center h-100" >
			...
			<h3 class="text-center pt-6 font-3 font-lg-6 " style="color:#fff;z-index: 1;position: relative;" >از طریق وبلاگ دنیای دانش می‌توانید از خواندن موضوعات عالی لذت ببرید</h3>
			<form method="GET" action="{{route('blog')}}" class="position-relative d-flex mx-auto mt-3 justify-content-between" style="width: 600px;max-width: 90%;">
				<input type="text" name="" class="form-control  mx-auto font-2" style="background: rgb(255 255 255 / 52%);box-shadow: none;border-radius: 50px;color: #fff;padding: 20px 40px;box-shadow: 0 1px 1px rgb(0 0 0 / 5%);border-color: #D0D0D0;" placeholder="در پلتفرم جستجو کنید">
